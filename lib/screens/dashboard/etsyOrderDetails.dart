...
class EtsyOrderDetails extends StatefulWidget {
  final EtsyOrder _order;
  final String _token;

  EtsyOrderDetails(this._order, this._token);

  @override
  _EtsyOrderDetailsState createState() => _EtsyOrderDetailsState();
}

class _EtsyOrderDetailsState extends State<EtsyOrderDetails> {
              ...
              children: [
                Expanded(
                  child: GlowingOverscrollIndicator(
                    ...
                    color: new Color(0xFFFFAF), //new Color(0x5579de79),
                    child: ListView(
                      children: [
                              ...
                              onPressed: _locationValue == null ||
                                  ...
                                  : () async {
                                      ...
                                      /* var fulfillStatus = await postAuthData(
                                          ...
                                          fulfillment,
                                          widget._token); */
                                      var fulfillStatus = {"status_code": 200};
